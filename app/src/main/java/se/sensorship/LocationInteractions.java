...
/**
 * Created by Wycheproof on 15-04-13.
 */
public class LocationInteractions implements LocationListener {

    private final String TAG = "LocationInteractions";
    Location lastLocation;
    GoogleApiClient googleApiClient;
    private LatLng[] turnPoints = {new LatLng(55.703503700000006, 13.2191062),
            new LatLng(55.7090651, 13.2399845)};
    ...
    public LocationInteractions(GoogleApiClient googleApiClient){
    ...
    private void updateUI() {
        //TODO skicka information till LocationService om ny info i notifkationen
        Log.d(TAG,"updateUI: " + lastLocation.toString());
    }
}
